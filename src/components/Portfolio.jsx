					...
					<Card className="Portfolio-card">
						...
						<Row className="Portfolio-row">
							<Col>
								...
								<p className="Portfolio-body" style={{ textIndent: "5%" }}> • Engineering Capstone: Mechanial Tracking for Arthoscopic Surgery <a className="Portfolio-href" href='#'> >>See Project </a></p>
							</Col>
						</Row>
						<Row className="Portfolio-row">
							<Col>
								...
								<p className="Portfolio-body" style={{ textIndent: "5%" }}> • 3rd place @ Ideas Inc Hackathon: Joy Bike Share <a className="Portfolio-href" href='#'> >>See Project </a></p>
							</Col>
						</Row>
					</Card>
				</Container>
